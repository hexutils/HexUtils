        ...
        for tind, tree in enumerate(treenames):
            ...
            for ent in trange(t.GetEntries()):
                ...
                while t.GetEntry(ent):
                    ...
                    """
                    if( (t.nCleanedJetsPt30 < 2) or (t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal <= 0) ):
                        if( ((t.nCleanedJetsPt30 >= 2) and (t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal <= 0)) or ((t.nCleanedJetsPt30 < 2) and (t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal > 0)) ):
                            print("ERROR: \t'nCleanedJetsPt30' does not agree with the sign of 'p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal'!")
                            print("nCleanedJetsPt30 = {} \t BUT \t p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal = {}".format(t.nCleanedJetsPt30, t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal))
                            sys.exit()
                        tag = "non2j"
                    """
                    if( t.nCleanedJetsPt30 < 2 ):
                        if( t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal == 0 ): print("\np_JJVBF_SIG_ghv1_1_JHUGen_JECNominal == 0\n")
                        elif( t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal > 0 ): 
                            print("ERROR: \t'nCleanedJetsPt30' does not agree with 'p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal'!")
                            print("nCleanedJetsPt30 = {} \t BUT \t p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal = {}".format(t.nCleanedJetsPt30, t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal))
                            sys.exit()
                        tag = "non2j"

                    elif( t.nExtraLep==0 and (((t.nCleanedJetsPt30==2 or t.nCleanedJetsPt30==3) and t.nCleanedJetsPt30BTagged_bTagSF<=1) or (t.nCleanedJetsPt30>=4 and t.nCleanedJetsPt30BTagged_bTagSF==0)) and D_VBF2j>WP_VBF2j ):
                        tag = "VBF"
                    ...
                    elif tag == "VBF": branchdict["EventTag"].append(1)
