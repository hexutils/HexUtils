...
treelist = [
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/OffshellAC/VBF/VBFToHiggs0PMToZZTo4l_M125_GaSM/ZZ4lAnalysis.root',
 
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/HighMass/VBFTo2e2muJJ_0PMH125_phantom128/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/HighMass/VBFTo4eJJ_0PMH125_phantom128/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/HighMass/VBFTo4muJJ_0PMH125_phantom128/ZZ4lAnalysis.root',
 
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/VBFH125/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/WminusH125/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/WplusH125/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/ZH125/ZZ4lAnalysis.root',
 
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/AC17/VBFH0PM_M125/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/AC17/WH0PM_M125/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/AC17/ZH0PM_M125/ZZ4lAnalysis.root',
 
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/HighMass/VBFH200/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/HighMass/WminusH200/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/HighMass/WplusH200/ZZ4lAnalysis.root',
 '/eos/user/l/lkang/Active_Research/TaggedTrees/MC_validation_WPsel_non2junderflow/cjlst/RunIILegacy/200205_CutBased/MC_2017/HighMass/ZH200/ZZ4lAnalysis.root']
...
for ntree, tree in enumerate(tqdm(treelist)):
    ...
    if os.path.exists('parquet/'+tree.split('/')[-2]+'_lepmc.parquet') and os.path.exists('parquet/'+tree.split('/')[-2]+'_jetmc.parquet') and os.path.exists('parquet/'+tree.split('/')[-2]+'_allmc.parquet'):
        continue
    ...
    mcweight = '137 * 1000 * xsec / {}'.format(t.num_entries)
    evweight = '137 * 1000 * xsec * overallEventWeight * L1prefiringWeight / Bin40'
...
#     jetmc = jetmc.loc[pd.IndexSlice[:, [0,1]], :]
    ...
    branch = ['EventNumber', 'EventTag', 'GenHMass', 'ZZMass', 'Dbsi', 'Dbkg'] + t.keys(filter_name='D2*') + t.keys(filter_name='p_Gen*')
    ...
    lepmc.to_parquet('parquet/'+tree.split('/')[-2]+'_test_lepmc.parquet')
    jetmc.to_parquet('parquet/'+tree.split('/')[-2]+'_test_jetmc.parquet')
    allmc.to_parquet('parquet/'+tree.split('/')[-2]+'_test_allmc.parquet')
