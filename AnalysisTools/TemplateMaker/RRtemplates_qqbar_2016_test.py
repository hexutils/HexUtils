...
treelist = glob.glob('/eos/user/g/gritsan/Write/TaggedTrees/OffshellTemplateTrees20220923/nominal/cjlst/RunIILegacy/200205_CutBased/{}/ZZTo4lext/ZZ4lAnalysis.root'.format(yearpth[sys.argv[1]]))
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/qqbar_test/{}/{}/templateOutput2_{}_{}_parts.root".format(tagpath[sys.argv[3]], sys.argv[1], sys.argv[1], sys.argv[2])
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/qqbar_test/{}/{}/templateOutput2_{}_{}_final.root".format(tagpath[sys.argv[3]], sys.argv[1], sys.argv[1], sys.argv[2])
