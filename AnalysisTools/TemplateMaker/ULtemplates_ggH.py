...
treelist4e = glob.glob('/eos/user/g/gritsan/Write/TaggedTrees/UL_CJLST_test/cjlst/Run2UL_22/Hadded/MC_offshell/MC2016/ggTo4e*/ZZ4lAnalysis.root')
treelist4mu = glob.glob('/eos/user/g/gritsan/Write/TaggedTrees/UL_CJLST_test/cjlst/Run2UL_22/Hadded/MC_offshell/MC2016/ggTo4mu*/ZZ4lAnalysis.root')
treelist4tau = glob.glob('/eos/user/g/gritsan/Write/TaggedTrees/UL_CJLST_test/cjlst/Run2UL_22/Hadded/MC_offshell/MC2016/ggTo4tau*/ZZ4lAnalysis.root')
treelist2e2mu = glob.glob('/eos/user/g/gritsan/Write/TaggedTrees/UL_CJLST_test/cjlst/Run2UL_22/Hadded/MC_offshell/MC2016/ggTo2e2mu*/ZZ4lAnalysis.root')
treelist2e2tau = glob.glob('/eos/user/g/gritsan/Write/TaggedTrees/UL_CJLST_test/cjlst/Run2UL_22/Hadded/MC_offshell/MC2016/ggTo2e2tau*/ZZ4lAnalysis.root')
treelist2mu2tau = glob.glob('/eos/user/g/gritsan/Write/TaggedTrees/UL_CJLST_test/cjlst/Run2UL_22/Hadded/MC_offshell/MC2016/ggTo2mu2tau*/ZZ4lAnalysis.root')
...
if sys.argv[1] == '4e': 
    ...
    lumi = 137.1
elif sys.argv[1] == '4tau': 
    treelist = treelist4tau
    lumi = 137.1
elif sys.argv[1] == '2e2mu':
    treelist = treelist2e2mu
    lumi = 137.1
elif sys.argv[1] == '2e2tau':
    treelist = treelist2e2tau
    lumi = 137.1
elif sys.argv[1] == '2mu2tau':
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/ULtemplates/inclusive/{}/templateOutput_{}_{}_parts.root".format(sys.argv[1], sys.argv[1], sys.argv[2])
...
histout = ROOT.TH3F('hist_{}'.format(sys.argv[2]), 'UL ggH {} {}'.format(sys.argv[1], sys.argv[2]), len(medges)-1, medges, len(d1edges)-1, d1edges, len(d2edges)-1, d2edges)
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/ULtemplates/inclusive/{}/templateOutput_{}_{}_final.root".format(sys.argv[1], sys.argv[1], sys.argv[2])
