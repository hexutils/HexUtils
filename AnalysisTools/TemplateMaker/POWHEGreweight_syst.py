...
'''
python3 POWHEGreweight_syst.py <year> <component> <syst> <tag>
...
treelist = glob.glob('/eos/user/s/skyriaco/Offshell/newSyst/{}/{}/200205_CutBased/{}/ggH*/ZZ4lAnalysis.root'.format(sys.argv[3][:-1], sys.argv[3], yearpth[sys.argv[1]])) + glob.glob('/eos/user/s/skyriaco/Offshell/newSyst/{}/{}/200205_CutBased/{}/HighMass/ggH*/ZZ4lAnalysis.root'.format(sys.argv[3][:-1], sys.argv[3], yearpth[sys.argv[1]]))

print(treelist)

#################### CHECK OUTPUT EXISTENCE ####################

if os.path.isfile("/eos/user/l/lkang/www/research/Sandbox/POWHEGtemplates/{}/{}/{}/templateOutput_{}_{}_final.root".format(sys.argv[3][:-1], sys.argv[3], tagpath[sys.argv[4]], sys.argv[1], sys.argv[2])): sys.exit()
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/POWHEGtemplates/{}/{}/{}/templateOutput_{}_{}_parts.root".format(sys.argv[3][:-1], sys.argv[3], tagpath[sys.argv[4]], sys.argv[1], sys.argv[2])
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/POWHEGtemplates/{}/{}/{}/templateOutput_{}_{}_final.root".format(sys.argv[3][:-1], sys.argv[3], tagpath[sys.argv[4]], sys.argv[1], sys.argv[2])
