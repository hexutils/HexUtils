...
foutname = "/eos/user/l/lkang/www/research/Sandbox/ULtemplates/qqbar/untagged/{}/templateOutput_{}_{}_parts.root".format(sys.argv[1], sys.argv[1], sys.argv[2])
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/ULtemplates/qqbar/untagged/{}/templateOutput_{}_{}_final.root".format(sys.argv[1], sys.argv[1], sys.argv[2])
