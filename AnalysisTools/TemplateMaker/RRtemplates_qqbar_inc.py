...
'''
python3 RRtemplates_qqbar.py <year> <component>
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/RRtemplates/qqbar/inclusive/{}/templateOutput_{}_{}_parts.root".format(sys.argv[1], sys.argv[1], sys.argv[2])
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/RRtemplates/qqbar/inclusive/{}/templateOutput_{}_{}_final.root".format(sys.argv[1], sys.argv[1], sys.argv[2])
