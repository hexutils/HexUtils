...
'''
python3 RRtemplates_VBF.py <year> <component> <tag>
...
treelist = glob.glob('/eos/user/g/gritsan/Write/TaggedTrees/OffshellTemplateTrees20220923/nominal/cjlst/RunIILegacy/200205_CutBased/{}/OffshellAC/VBF/VBFTo*/ZZ4lAnalysis.root'.format(yearpth[sys.argv[1]]))
...
for i, fname in enumerate(tqdm(treelist)):
    ...
    if sys.argv[2] == 'SIG':
        ...
        for iev,event in tqdm(enumerate(t)):
            if iev==0: weight_nom = lumi * 500 * event.xsec / event.Bin40
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/RRtemplates/VBF/{}/{}/templateOutput_{}_{}_parts.root".format(tagpath[sys.argv[3]], sys.argv[1], sys.argv[1], sys.argv[2])
...
histout = ROOT.TH3F('hist_{}'.format(sys.argv[2]), 'ReRECO VBF {} {}'.format(sys.argv[1], sys.argv[2]), len(medges)-1, medges, len(d1edges)-1, d1edges, len(d2edges)-1, d2edges)
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/RRtemplates/VBF/{}/{}/templateOutput_{}_{}_final.root".format(tagpath[sys.argv[3]], sys.argv[1], sys.argv[1], sys.argv[2])
