...
'''
python3 RRtemplates_ggH.py <year> <state> <component>
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/RRtemplates/ggH/inclusive/{}/templateOutput_{}_{}_parts.root".format(sys.argv[1], sys.argv[2], sys.argv[3])
...
foutname = "/eos/user/l/lkang/www/research/Sandbox/RRtemplates/ggH/inclusive/{}/templateOutput_{}_{}_final.root".format(sys.argv[1], sys.argv[2], sys.argv[3])
