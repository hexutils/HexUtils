...
void testME_Dec_MCFM_Ping(int flavor=2, int useMothers=0, bool useConstants=false, shared_ptr<Mela> melaptr=nullptr){
  ...
  */
  ...
  for (int ev = 2; ev < 3; ev++){
    ...
    float pVAMCFM_ZZ_sig_selfDg1gzgs2;
    mela.setProcess(TVar::HSMHiggs, TVar::MCFM, TVar::ZZGG);
    mela.selfDHbbcoupl[0][gHIGGS_KAPPA][0]=1.0;
    mela.selfDHttcoupl[0][gHIGGS_KAPPA][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    ...
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAMCFM_ZZ_sig_selfDg1gzgs2, useConstants);
    cout << "pVAMCFM_ZZ_sig_selfDg1gzgs2: " << pVAMCFM_ZZ_sig_selfDg1gzgs2 << '\n' << endl;

    float pVAMCFM_ZZ_sig_selfDg1gzgs4;
    mela.setProcess(TVar::HSMHiggs, TVar::MCFM, TVar::ZZGG);
    mela.selfDHbbcoupl[0][gHIGGS_KAPPA][0]=1.0;
    mela.selfDHttcoupl[0][gHIGGS_KAPPA][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    ...
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAMCFM_ZZ_sig_selfDg1gzgs4, useConstants);
    cout << "pVAMCFM_ZZ_sig_selfDg1gzgs4: " << pVAMCFM_ZZ_sig_selfDg1gzgs4 << '\n' << endl;

    float pVAMCFM_ZZ_sig_selfDg1gzgs2im;
    mela.setProcess(TVar::HSMHiggs, TVar::MCFM, TVar::ZZGG);
    mela.selfDHbbcoupl[0][gHIGGS_KAPPA][0]=1.0;
    mela.selfDHttcoupl[0][gHIGGS_KAPPA][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    ...
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAMCFM_ZZ_sig_selfDg1gzgs2im, useConstants);
    cout << "pVAMCFM_ZZ_sig_selfDg1gzgs2im: " << pVAMCFM_ZZ_sig_selfDg1gzgs2im << '\n' << endl;

    float pVAMCFM_ZZ_sig_selfDg1gzgs4im;
    mela.setProcess(TVar::HSMHiggs, TVar::MCFM, TVar::ZZGG);
    mela.selfDHbbcoupl[0][gHIGGS_KAPPA][0]=1.0;
    mela.selfDHttcoupl[0][gHIGGS_KAPPA][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    ...
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAMCFM_ZZ_sig_selfDg1gzgs4im, useConstants);
    cout << "pVAMCFM_ZZ_sig_selfDg1gzgs4im: " << pVAMCFM_ZZ_sig_selfDg1gzgs4im << '\n' << endl;

    float pVAJHU_ZZ_sig_selfDg1;
    mela.setProcess(TVar::SelfDefine_spin0, TVar::JHUGen, TVar::ZZGG);
    mela.selfDHggcoupl[0][gHIGGS_GG_2][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAJHU_ZZ_sig_selfDg1, useConstants);
    cout << "pVAJHU_ZZ_sig_selfDg1: " << pVAJHU_ZZ_sig_selfDg1 << '\n' << endl;

    float pVAJHU_ZZ_sig_selfDg1gzgs2;
    mela.setProcess(TVar::SelfDefine_spin0, TVar::JHUGen, TVar::ZZGG);
    mela.selfDHggcoupl[0][gHIGGS_GG_2][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_ZA_2][0]=1.0;
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAJHU_ZZ_sig_selfDg1gzgs2, useConstants);
    cout << "pVAJHU_ZZ_sig_selfDg1gzgs2: " << pVAJHU_ZZ_sig_selfDg1gzgs2 << '\n' << endl;

    float pVAJHU_ZZ_sig_selfDg1gzgs4;
    mela.setProcess(TVar::SelfDefine_spin0, TVar::JHUGen, TVar::ZZGG);
    mela.selfDHggcoupl[0][gHIGGS_GG_2][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_ZA_4][0]=1.0;
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAJHU_ZZ_sig_selfDg1gzgs4, useConstants);
    cout << "pVAJHU_ZZ_sig_selfDg1gzgs4: " << pVAJHU_ZZ_sig_selfDg1gzgs4 << '\n' << endl;

    float pVAJHU_ZZ_sig_selfDg1gzgs2im;
    mela.setProcess(TVar::SelfDefine_spin0, TVar::JHUGen, TVar::ZZGG);
    mela.selfDHggcoupl[0][gHIGGS_GG_2][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_ZA_2][1]=1.0;
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAJHU_ZZ_sig_selfDg1gzgs2im, useConstants);
    cout << "pVAJHU_ZZ_sig_selfDg1gzgs2im: " << pVAJHU_ZZ_sig_selfDg1gzgs2im << '\n' << endl;

    float pVAJHU_ZZ_sig_selfDg1gzgs4im;
    mela.setProcess(TVar::SelfDefine_spin0, TVar::JHUGen, TVar::ZZGG);
    mela.selfDHggcoupl[0][gHIGGS_GG_2][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1.0;
    mela.selfDHzzcoupl[0][gHIGGS_ZA_4][1]=1.0;
    mela.setMelaHiggsWidth(wPOLE);
    mela.setMelaLeptonInterference(TVar::InterfOn);
    mela.computeP(pVAJHU_ZZ_sig_selfDg1gzgs4im, useConstants);
    cout << "pVAJHU_ZZ_sig_selfDg1gzgs4im: " << pVAJHU_ZZ_sig_selfDg1gzgs4im << '\n' << endl;

    cout << "MCFM vs JHUGen Ratio comparison:" << endl;

    cout << "ZZ_sig_selfDg1gzgs2: " << pVAMCFM_ZZ_sig_selfDg1gzgs2/pVAMCFM_ZZ_sig_selfDg1 << '\t' << pVAJHU_ZZ_sig_selfDg1gzgs2/pVAJHU_ZZ_sig_selfDg1 << endl;
    cout << "ZZ_sig_selfDg1gzgs4: " << pVAMCFM_ZZ_sig_selfDg1gzgs4/pVAMCFM_ZZ_sig_selfDg1 << '\t' << pVAJHU_ZZ_sig_selfDg1gzgs4/pVAJHU_ZZ_sig_selfDg1 << endl;
    cout << "ZZ_sig_selfDg1gzgs2im: " << pVAMCFM_ZZ_sig_selfDg1gzgs2im/pVAMCFM_ZZ_sig_selfDg1 << '\t' << pVAJHU_ZZ_sig_selfDg1gzgs2im/pVAJHU_ZZ_sig_selfDg1 << endl;
    cout << "ZZ_sig_selfDg1gzgs4im: " << pVAMCFM_ZZ_sig_selfDg1gzgs4im/pVAMCFM_ZZ_sig_selfDg1 << '\t' << pVAJHU_ZZ_sig_selfDg1gzgs4im/pVAJHU_ZZ_sig_selfDg1 << endl;
    cout << endl;
...
void testME_ProdDec_MCFM_JHUGen_WBFZZWW_Comparison_Ping(int motherflavor=0, int isZZWW=0 /*1==ZZ, 2==WW*/, int vbfvhchannel=0 /*0==VBF, 1==HadVH, 2==LepVH*/, int decZZWW=1 /*1==ZZ, 2==WW*/, int hasInterf=0 /*0==2l2l, 1==4l*/, shared_ptr<Mela> melaptr=nullptr){
  ...
  if (doEval){
    ...
    jhume p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU;
    ...
    mcfmme p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAMCFM;
    ...
    mela.selfDHzzcoupl[0][gHIGGS_VV_1][0]=1;
    mela.selfDHzzcoupl[0][gHIGGS_VV_4][1]=-1;
    mela.computeP(p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.decme, false);
    ...
    if (vbfvhchannel==0){
      ...
      mela.computeProdP(p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.prodme, false);
      mela.getIORecord()->getUnweightedMEArray(p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.mearray);
    ...
    p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.prodme *= propagator; p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.multiplyarray(propagator);
    ...
    if (isZZWW==ZZWWdec_onevertexflag){ // MCFM setting below turns off ZZ anomalous couplings if WH with WW couplings tested, so we should do the same here.
      ...
      p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.proddecme = p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.prodme*p_prod_0mplus_dec_0mplus_VAJHU.decme; p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.multiplyarray(p_prod_0mplus_dec_0mplus_VAJHU.decme);
    }
    else{
      ...
      p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.proddecme = p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.prodme*p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.decme; p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.multiplyarray(p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.decme);
    }
    ...
    mela.computeProdDecP(p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAMCFM.proddecme, false);
    mela.getIORecord()->getUnweightedMEArray(p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAMCFM.mearray);
    ...
    cout << "fa3, phia3=270" << endl;
    cout << "\tJHUGen decay-alone: " << p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.decme << endl;
    cout << "\tJHUGen prod.-alone: " << p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.prodme << endl;
    cout << "\tJHUGen ME: " << p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.proddecme << endl;
    cout << "\tMCFM ME: " << p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAMCFM.proddecme << endl;
    cout << "0mplusL2" << endl;
    ...
    cout << "fa3, phia3=270" << endl;
    cout << "\tJHUGen" << endl;
    p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.printarray();
    cout << "\tMCFM" << endl;
    p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAMCFM.printarray();
    cout << "\tJHUGen/MCFM Ratio" << endl;
    for (int ii=0; ii<nmsq; ii++){
      for (int jj=0; jj<nmsq; jj++){
        cout << '\t';
        if (p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAMCFM.mearray[ii][jj]!=0.) cout << p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAJHU.mearray[ii][jj]/p_prod_fa3_phia3_270_dec_fa3_phia3_270_VAMCFM.mearray[ii][jj];
        else cout << 0;
      }
      cout << endl;
    }
