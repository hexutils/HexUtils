...
def main(argv):
    ...
    if not os.path.exists(filename):
        ...
        fobjects = [key.GetName() for key in f.GetListOfKeys()]
            ...
            for ent in trange(t.GetEntries()):
                ...
                while t.GetEntry(ent):
                    ...
                    if tree == "candTree_failed":
                        ...
                        branchdict["D2jVBFold"].append(-999)
                    ...
                    D_VBF2jold = DVBF2j_ME(t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal, t.p_JJQCD_SIG_ghg2_1_JHUGen_JECNominal, ZZMass, cConstants_list)
                    branchdict["D2jVBFold"].append(D_VBF2jold)
                    WP_VBF2j = getDVBF2jetsWP(ZZMass, useQGTagging)

                    D_VBF2j = DVBF2j_ME(t.p_JJVBF_SIG_ghv1_1_JHUGen_JECNominal_v2, t.p_JJQCD_SIG_ghg2_1_JHUGen_JECNominal_v2, ZZMass, cConstants_list)
