...
#  t = f.Get("ZZTree/candTree")
  ...
  try:
    ...
    prop_test1 = np.array([0], dtype=np.float64)
    ...
    newt.Branch("prop_test1", prop_test1,"prop_test1/D")
...
#      prop_125_407[0] = m.computeP()
#      print(prop_125_407[0])
...
#      m.getProcess()
      ...
      m.ghg2 = 1
      m.ghz1 = 1
      prop_test1[0] = m.getXPropagator(TVar.FixedWidth)
#      prop_test1[0] = m.computeP()
#      print(prop_test1[0])
...
#      print(prop_125_407[0], prop_125_4029[0], prop_test[0], prop_test1[0])
...
#  fout = "/eos/user/l/lkang/www/research/Analysis/SMEFT/rewgt/MELA/"+fin.split('/')[-2]+".root"
  fout = "/eos/user/l/lkang/www/research/Analysis/SMEFT/rewgt/MELA/"+fin.split('/')[-1].replace(".root", "_prop.root")
