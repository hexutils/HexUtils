...
def main(argv):
    ...
    outtreefilename = "/eos/user/l/lkang/www/research/Analysis/SMEFT/rewgt/MELA/TEST.root"
...
#    quit()
    ...
    lhe2root = False
    if not lhe2root: from AnalysisTools.Utils.MELA_Weights_AC_BKG import addprobabilities
