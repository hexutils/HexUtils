...
def init_LEPSF():
  ...
  # 2016 Electrons
  fipEleNotCracks_2016 = wkdir+"LepSF/ElectronSF_Legacy_2016_NoGap.root"
  ...
  fipEleCracks_2016 = wkdir+"LepSF/ElectronSF_Legacy_2016_Gap.root"
  ...
  fipEleReco_highPt_2016 = wkdir+"LepSF/Ele_Reco_2016.root"
  ...
  fipEleReco_lowPt_2016 = wkdir+"LepSF/Ele_Reco_LowEt_2016.root"
  ...
  # 2017 Electrons
  fipEleNotCracks_2017 = wkdir+"LepSF/ElectronSF_Legacy_2017_NoGap.root"
  ...
  fipEleCracks_2017 = wkdir+"LepSF/ElectronSF_Legacy_2017_Gap.root"
  ...
  fipEleReco_highPt_2017 = wkdir+"LepSF/Ele_Reco_2017.root"
  ...
  fipEleReco_lowPt_2017 = wkdir+"LepSF/Ele_Reco_LowEt_2017.root"
  ...
  fipEleNotCracks_2018 = wkdir+"LepSF/ElectronSF_Legacy_2018_NoGap.root"
  ...
  fipEleCracks_2018 = wkdir+"LepSF/ElectronSF_Legacy_2018_Gap.root"
  ...
  fipEleReco_highPt_2018 = wkdir+"LepSF/Ele_Reco_2018.root"
  ...
  fipEleReco_lowPt_2018 = wkdir+"LepSF/Ele_Reco_LowEt_2018.root"
  ...
  # 2016 Muons
  fipMu_2016 = wkdir+"LepSF/final_HZZ_muon_SF_2016RunB2H_legacy_newLoose_newIso_paper.root"
  ...
  # 2017 Muons
  fipMu_2017 = wkdir+"LepSF/final_HZZ_muon_SF_2017_newLooseIso_mupogSysts_paper.root"
  ...
  # 2018 Muons
  fipMu_2018 = wkdir+"LepSF/final_HZZ_muon_SF_2018RunA2D_ER_newLoose_newIso_paper.root"
  ...
  return [h_Ele_notCracks_2016,h_Ele_Cracks_2016,h_Ele_Reco_highPT_2016,h_Ele_Reco_lowPT_2016,h_Ele_notCracks_2017,h_Ele_Cracks_2017,h_Ele_Reco_highPT_2017,h_Ele_Reco_lowPT_2017,h_Ele_notCracks_2018,h_Ele_Cracks_2018,h_Ele_Reco_highPT_2018,h_Ele_Reco_lowPT_2018,h_Mu_SF_2016,h_Mu_Unc_2016,h_Mu_SF_2017,h_Mu_Unc_2017,h_Mu_SF_2018,h_Mu_Unc_2018]
  
def getSF(year, flav, pt, eta, SCeta, isCrack, LEPSF_Input):

   #LEPSF_Input = init_LEPSF()

   h_Ele_notCracks_2016=LEPSF_Input[0]
   h_Ele_Cracks_2016=LEPSF_Input[1]
   h_Ele_Reco_highPT_2016=LEPSF_Input[2]
   h_Ele_Reco_lowPT_2016=LEPSF_Input[3]
   h_Ele_notCracks_2017=LEPSF_Input[4]
   h_Ele_Cracks_2017=LEPSF_Input[5]
   h_Ele_Reco_highPT_2017=LEPSF_Input[6]
   h_Ele_Reco_lowPT_2017=LEPSF_Input[7]
   h_Ele_notCracks_2018=LEPSF_Input[8]
   h_Ele_Cracks_2018=LEPSF_Input[9]
   h_Ele_Reco_highPT_2018=LEPSF_Input[10]
   h_Ele_Reco_lowPT_2018 =LEPSF_Input[11]
   h_Mu_SF_2016=LEPSF_Input[12]
   h_Mu_Unc_2016=LEPSF_Input[13]
   h_Mu_SF_2017=LEPSF_Input[14]
   h_Mu_Unc_2017=LEPSF_Input[15]
   h_Mu_SF_2018=LEPSF_Input[16]
   h_Mu_Unc_2018=LEPSF_Input[17]
...
def fixleptonscalefactor(year, LepLepId, LepPt, LepEta, dataMCWeight, LepSF):
  updatedSF = (
    getSF(year, LepLepId[0], LepPt[0], LepEta[0], LepEta[0], False, LepSF) *
    getSF(year, LepLepId[1], LepPt[1], LepEta[1], LepEta[1], False, LepSF) *
    getSF(year, LepLepId[2], LepPt[2], LepEta[2], LepEta[2], False, LepSF) *
    getSF(year, LepLepId[3], LepPt[3], LepEta[3], LepEta[3], False, LepSF)
  )
