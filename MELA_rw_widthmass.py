...
#    newt.Branch("massRW_Interf",massRW_Interf,"massRW_Interf")
    ...
    prop_125_29 = np.array([0], dtype=np.float64)
    prop_125p38_29 = np.array([0], dtype=np.float64)
    prop_125_7 = np.array([0], dtype=np.float64)
    prop_125p38_7 = np.array([0], dtype=np.float64)
    prop_TEST = np.array([0], dtype=np.float64)

    newt.Branch("prop_125_29",prop_125_29,"prop_125_29")
    newt.Branch("prop_125p38_29",prop_125p38_29,"prop_125p38_29")
    newt.Branch("prop_125_7",prop_125_7,"prop_125_7")
    newt.Branch("prop_125p38_7",prop_125p38_7,"prop_125p38_7")
    newt.Branch("prop_TEST",prop_TEST,"prop_TEST")
    ...
    for i, entry in enumerate(t, start=1):
      ...
      m.setMelaHiggsMassWidth(125.000,0.004029,0)
      m.setInputEvent(leptons, jets, mothers, 1)
      m.ghg2 = 1
      m.ghz1 = 1
