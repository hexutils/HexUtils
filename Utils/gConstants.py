...
import Config
def init_gConstants():
  config = Config.Analysis_Config("OnShell_HVV_Photons_2021")
  wkdir = config.Path_To_Utils
  gConstant_HZZ2e2mu_g2 = ROOT.TFile(wkdir+"/gConstants/gConstant_HZZ2e2mu_g2.root").Get("sp_tgfinal_HZZ2e2mu_SM_over_tgfinal_HZZ2e2mu_g2")
  gConstant_HZZ2e2mu_g4 = ROOT.TFile(wkdir+"/gConstants/gConstant_HZZ2e2mu_g4.root").Get("sp_tgfinal_HZZ2e2mu_SM_over_tgfinal_HZZ2e2mu_g4")
  gConstant_HZZ2e2mu_L1 = ROOT.TFile(wkdir+"/gConstants/gConstant_HZZ2e2mu_L1.root").Get("sp_tgfinal_HZZ2e2mu_SM_over_tgfinal_HZZ2e2mu_L1")
  gConstant_HZZ2e2mu_L1Zgs = ROOT.TFile(wkdir+"/gConstants/gConstant_HZZ2e2mu_L1Zgs.root").Get("sp_tgfinal_HZZ2e2mu_SM_photoncut_over_tgfinal_HZZ2e2mu_L1Zgs")
  gConstant_VBF_g2 = ROOT.TFile(wkdir+"/gConstants/gConstant_VBF_g2.root").Get("sp_tgfinal_VBF_SM_over_tgfinal_VBF_g2")
  gConstant_VBF_g4 = ROOT.TFile(wkdir+"/gConstants/gConstant_VBF_g4.root").Get("sp_tgfinal_VBF_SM_over_tgfinal_VBF_g4")
  gConstant_VBF_L1 = ROOT.TFile(wkdir+"/gConstants/gConstant_VBF_L1.root").Get("sp_tgfinal_VBF_SM_over_tgfinal_VBF_L1")
  gConstant_VBF_L1Zgs = ROOT.TFile(wkdir+"/gConstants/gConstant_VBF_L1Zgs.root").Get("sp_tgfinal_VBF_SM_photoncut_over_tgfinal_VBF_L1Zgs")
  gConstant_ZH_g2 = ROOT.TFile(wkdir+"/gConstants/gConstant_ZH_g2.root").Get("sp_tgfinal_ZH_SM_over_tgfinal_ZH_g2")
  gConstant_ZH_g4 = ROOT.TFile(wkdir+"/gConstants/gConstant_ZH_g4.root").Get("sp_tgfinal_ZH_SM_over_tgfinal_ZH_g4")
  gConstant_ZH_L1 = ROOT.TFile(wkdir+"/gConstants/gConstant_ZH_L1.root").Get("sp_tgfinal_ZH_SM_over_tgfinal_ZH_L1")
  gConstant_ZH_L1Zgs = ROOT.TFile(wkdir+"/gConstants/gConstant_ZH_L1Zgs.root").Get("sp_tgfinal_ZH_SM_photoncut_over_tgfinal_ZH_L1Zgs")
  gConstant_VH_g2 = ROOT.TFile(wkdir+"/gConstants/gConstant_VH_g2.root").Get("sp_tgfinal_ZH_SM_plus_tgfinal_WH_SM_over_tgfinal_ZH_g2_plus_tgfinal_WH_g2")
  gConstant_VH_g4 = ROOT.TFile(wkdir+"/gConstants/gConstant_VH_g4.root").Get("sp_tgfinal_ZH_SM_plus_tgfinal_WH_SM_over_tgfinal_ZH_g4_plus_tgfinal_WH_g4")
  gConstant_VH_L1 = ROOT.TFile(wkdir+"/gConstants/gConstant_VH_L1.root").Get("sp_tgfinal_ZH_SM_plus_tgfinal_WH_SM_over_tgfinal_ZH_L1_plus_tgfinal_WH_L1")
  gConstant_VH_L1Zgs = ROOT.TFile(wkdir+"/gConstants/gConstant_VH_L1Zgs.root").Get("sp_tgfinal_ZH_SM_photoncut_plus_tgfinal_WH_SM_over_tgfinal_ZH_L1Zgs")
  gConstant_WH_g2 = ROOT.TFile(wkdir+"/gConstants/gConstant_WH_g2.root").Get("sp_tgfinal_WH_SM_over_tgfinal_WH_g2")
  gConstant_WH_g4 = ROOT.TFile(wkdir+"/gConstants/gConstant_WH_g4.root").Get("sp_tgfinal_WH_SM_over_tgfinal_WH_g4")
  gConstant_WH_L1 = ROOT.TFile(wkdir+"/gConstants/gConstant_WH_L1.root").Get("sp_tgfinal_WH_SM_over_tgfinal_WH_L1")
